  ...
  return (
    <>
      ...
      <p className="max-md:text-xl max-lg:text-2xl text-center text-3xl font-semibold mb-2">
        Review documents using our AI-based document review templates.
      </p>
      <p className="max-md:text-sm max-md:max-w-2xl max-lg:max-w-3xl  m-auto  text-center max-w-4xl max-sm:mb-2 mb-12 text-d">
        All your specialists will record their findings using a standard
        document review template to ensure consistency. Avoid key findings being
        missed by less experienced reviewers. This will save time being written
        off for collating inconsistent reports and re-working them to make them
        consistent.
      </p>
