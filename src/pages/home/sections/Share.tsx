  ...
  return (
    <>
      ...
      <p className="max-md:text-xl max-lg:text-2xl text-center text-3xl font-semibold mb-2">
        Share your findings with your client in real time.
      </p>
      <p className="max-md:text-sm max-md:max-w-2xl max-lg:max-w-3xl  m-auto  text-center max-w-4xl max-sm:mb-2 mb-12 text-d">
        Deals often move quickly and clients want to know what the red flags are
        as soon as they are discovered, to avoid any delays in completing the
        transaction. Differentiate yourself from your competitors by securely
        sharing your findings in real-time with your clients.
      </p>
