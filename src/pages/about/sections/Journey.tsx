...
const userJourneyCards: UserJourneyType[] = [
    {
        ...
        description: 'Anna assembles a team of specialist lawyers to review the documents',
        step: 'Step - 01'
    },
    {
    ...
    },
    {
        ...
        description: 'Tom goes through the documents and discusses the scope with the client',
        step: 'Step - 03'
    },
    {
        imageUrl: 'https://doitwithdue.com/images/user-journey/with-due-04.svg',
        description: 'Maple is notified she has been added to the project and has documents to review',
        step: 'Step - 04'
    },
    {
        imageUrl: 'https://doitwithdue.com/images/user-journey/with-due-05.svg',
        description: 'Maple heads back to her desk to look at the documents she needs to review and by when.',
        step: 'Step - 05'
    },
    {
        imageUrl: 'https://doitwithdue.com/images/user-journey/with-due-06.svg',
        description: 'Maple can ease into her work day with clarity and confidence knowing that she won’t miss anything in her document review as she is using an approved template.',
        step: 'Step - 06'
    },
    {
        imageUrl: 'https://doitwithdue.com/images/user-journey/with-due-07.svg',
        description: 'Maple’s review automatically forms part of the master report, along with the input of other specialists without having to save a local copy to share via email.',
        step: 'Step - 07'
    },
    {
        imageUrl: 'https://doitwithdue.com/images/user-journey/with-due-08.svg',
        description: 'Maple and Tom review the list of red flags identified by the specialist reviewers, all consistently written and presented',
        step: 'Step - 08'
    },
    {
        imageUrl: 'https://doitwithdue.com/images/user-journey/with-due-09.svg',
        description: 'Tom shares updates and early findings with the client, allowing them to update their purchasing strategy.',
        step: 'Step - 09'
    },
    {
        imageUrl: 'https://doitwithdue.com/images/user-journey/with-due-10.svg',
        description: 'Congratulations, you helped your client close another deal on time and on budget!',
        step: 'Step - 10'
    }
]
