import About from '@/assets/icons/burger/about'
import Careers from '@/assets/icons/burger/careers'
import Contact from '@/assets/icons/burger/contact'
import Pricing from '@/assets/icons/burger/pricing'
...
export const Burgerlinks = [
  ...
  { to: '/pricing', icon: <Pricing />, text: 'Pricing' },
  { to: '/careers', icon: <Careers />, text: 'Careers' },
  { to: '/contact', icon: <Contact />, text: 'Contact us' },
]
